...
[Markdown for Agents](https://developers.cloudflare.com/fundamentals/reference/markdown-for-agents/)
enables this automatically for Cloudflare zones â€” no application code changes needed.
...
{"url": "https://neoflowoff.agency", "checks": ["contentAccessibility.markdownNegotiation"]}
```
