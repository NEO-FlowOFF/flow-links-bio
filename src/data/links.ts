    ...
    links: [
      {
        ...
        hero: true,
        badges: [
          { label: "Live · Base Mainnet", color: "pink", pulse: true },
      ...
      },
      {
        ...
        color: "pink",
        featured: true,
        badges: [{ label: "Agency", color: "pink" }],
      },
      {
        ...
        color: "pink",
        featured: true,
        badges: [{ label: "💸 Economize nas taxas", color: "pink" }],
      },
      {
        ...
        featured: true,
        badges: [
          { label: "🌐 Interplanetary Gate", color: "pink" },
          { label: "IPFS", color: "pink" },
        ],
      },
    ],
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        color: "pink",
        badges: [{ label: "Em breve", color: "pink", pulse: true }],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        color: "pink",
        badges: [{ label: "Live", color: "pink", pulse: true }],
      },
    ],
  },
];
