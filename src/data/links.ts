export type BadgeColor = "pink" | "green" | "amber" | "blue" | "purple" | "mono";
...
export const sections: LinkSection[] = [
    ...
    links: [
      {
        ...
        hero: true,
        badges: [
          { label: "Live · Base Mainnet", color: "green", pulse: true },
          { label: "ERC-20", color: "pink" },
        ],
      },
      {
        ...
        color: "blue",
        featured: true,
        badges: [{ label: "Agency", color: "blue" }],
      },
      {
        ...
        color: "green",
        featured: true,
        badges: [{ label: "💸 Economize nas taxas", color: "green" }],
      },
      {
        ...
        featured: true,
        badges: [
          { label: "🌐 Interplanetary Gate", color: "purple" },
          { label: "IPFS", color: "mono" },
        ],
      },
    ],
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        color: "amber",
        badges: [{ label: "Em breve", color: "amber", pulse: true }],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      {
        href: "https://www.flowpaycore.com/",
        title: "Open Source",
        sub: "flowpaycore.com",
      ...
      {
        href: "https://wod-landing.vercel.app/",
        title: "Gamificação",
      ...
      },
      {
        ...
        color: "blue",
        badges: [{ label: "Live", color: "blue", pulse: true }],
      },
    ],
  },
];
